...
#N=0
#for P in RR:
#	print('draw p'+str(N)+' {'+str(P.first)+','+str(P.second)+','+str(P.third)+'}')
#	N = N + 1
...
scipy.io.savemat('fm1.mat', {'RPT':RNMatrix, 'BPT':BNMatrix, 'RVT':RVMatrix, 'BVT':BVMatrix})
